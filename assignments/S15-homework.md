...
In React, styled components, are components that only send required css of the component that is being rendered. Since the component contains a mixture of both Javascript and CSS, the behavioral and styling aspects of a web page, it is considered to violate the sepration of concerns.  